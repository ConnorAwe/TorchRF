import torchrf
import torchrf.rt
import torchrf.rt.previewer
from torchrf.rt.scene import load_scene
scene = load_scene(torchrf.rt.scene.munich)

from torchrf.rt import PlanarArray, Transmitter, Receiver, Camera
import time
import os
...
scene.rx_array = PlanarArray(num_rows=1,
                             ...
                             vertical_spacing=0.5,
                             horizontal_spacing=0.5,
                             pattern="tr38901",  # pattern="dipole",
                             polarization="V")   # polarization="cross")
