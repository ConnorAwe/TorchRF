...
class OrientedObject(Object):
    ...
    look_at : [3], float | :class:`torchrf.rt.OrientedObject` | None
        A position or the instance of an :class:`~torchrf.rt.OrientedObject` to
        point toward to.
    ...
    def look_at(self, target):
        ...
        Input
        -----
        target : [3], float | :class:`torchrf.rt.OrientedObject` | str
            A position or the name or instance of an
            :class:`torchrf.rt.OrientedObject` in the scene to point toward to
        """
        pass
