...
class Camera(OrientedObject):
    ...
    look_at : [3], float | :class:`~torchrf.rt.Transmitter` | :class:`~torchrf.rt.Receiver` | :class:`~torchrf.rt.Camera` | None
        A position or instance of :class:`~torchrf.rt.Transmitter`,
    ...
    # However, torchrf uses Z as up and looks toward X+, for consistency
    # with radio devices.
    # The following transform peforms a rotation to ensure torchrf's
    # convention.
    # Note: Mitsuba uses degrees
    mi_2_torchrf = (mi.ScalarTransform4f.rotate([0, 0, 1], 90.0)
    ...
    def orientation(self, new_orientation):
        ...
        rot_mat = rot_z @ rot_y @ rot_x @ Camera.mi_2_torchrf
    ...
    def world_to_angles(to_world):
        ...
        # Undo the rotation to switch from Mitsuba to torchrf convention
        to_world = to_world @ Camera.mi_2_torchrf.inverse()
