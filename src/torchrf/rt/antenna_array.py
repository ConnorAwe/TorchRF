...
class AntennaArray():
    ...
    Parameters
    ----------
    antenna : :class:`~torchrf.rt.Antenna`
        Antenna instance
    ...
    positions : [array_size, 3], array_like
        ...
        adding the position of the :class:`~torchrf.rt.Transmitter`
        or :class:`~torchrf.rt.Receiver` using it.
    ...
    """
    def __init__(self, antenna, positions, trainable_positions=False, dtype=torch.complex64):
        super().__init__()
    ...
    def antenna(self):
        """
        :class:`~torchrf.rt.Antenna` : Get/set the antenna
        """
    ...
    def positions(self):
        """
        [array_size, 3], `torch.float` : Get/set  array of relative positions
