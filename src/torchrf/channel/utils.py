...
def time_lag_discrete_time_channel(bandwidth, maximum_delay_spread=3e-6):
    ...
    was found small enough for all models included in torchrf.
    ...
    included in torchrf assuming a nominal delay spread of 100ns.
...
def time_to_ofdm_channel(h_t, rg, l_min):
    ...
    resource_grid : :class:`~torchrf.ofdm.ResourceGrid`
        Resource grid
    ...
    output of :meth:`~torchrf.channel.utils.cir_to_ofdm_channel` because
    the discrete complex-baseband channel impulse response is truncated
    (see :meth:`~torchrf.channel.utils.cir_to_time_channel`). This effect
...
def gen_single_sector_topology( batch_size,
    ...
    :class:`~torchrf.channel.tr38901.UMi`, :class:`~torchrf.channel.tr38901.UMa`,
    and :class:`~torchrf.channel.tr38901.RMa`.
