...
from torchrf.channel.utils import subcarrier_frequencies, cir_to_ofdm_channel
import torch
...
class GenerateOFDMChannel:
    ...
    Parameters
    ----------
    channel_model : :class:`~torchrf.channel.ChannelModel` object
        An instance of a :class:`~torchrf.channel.ChannelModel` object, such as
        :class:`~torchrf.channel.RayleighBlockFading` or
        :class:`~torchrf.channel.tr38901.UMi`.
    ...
    Output
    -------
    h_freq : [batch size, num_rx, num_rx_ant, num_tx, num_tx_ant, num_ofdm_symbols, num_subcarriers], torch.complex
